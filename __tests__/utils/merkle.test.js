...
describe("Merkle Tree Integration Tests", () => {
  const csvData = parse(
    new TextEncoder()
...
0x70f2Db6D22593a65Dbb848C94eBACDF0344642F7,100000000000000000000`)
  ...
  test("getAllocationList should return correct allocation object", () => {
  ...
  test("getProof should return a valid proof for an address", () => {
  ...
  test("getProof should return undefined for an invalid address", () => {
