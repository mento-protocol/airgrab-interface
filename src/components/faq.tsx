            ...
            {({ open }) => (
              <>
                <Disclosure.Button
                  ...
                  className={`${
                    open ? "border-b" : ""
                  }  px-8 pb-6 pt-5 font-medium text-left text-[17px] text-fg flex justify-between w-full`}
                >
                  {question}
                ...
                <Disclosure.Panel className="flex flex-col leading-7 justify-around gap-4 px-8 pb-8 pt-6">
                  {answer}
                </Disclosure.Panel>
              </>
            )}
