      ...
      <div>
        <div className="h-[540px] w-[547px] sm:w-full md:min-h-[350px] md:max-w-[547px] flex flex-col p-[18px] bg-white shadow-md rounded-2xl overflow-visible border border-primary-dark">
          ...
          >
            ...
            [issuing company]. The Airdrop TnCs govern the ability to
            participate in the Airdrop. By participating and claiming MENTO
            Governance Tokens in the Airdrop, you agree to these Airdrop TnCs.
            If you don&apos;t agree with the Airdrop TnCs, please DO NOT ACCESS,
            USE, PARTICIPATE in the Airdrop. If you DO NOT AGREE to these TnCs
            YOU SHALL BE PROHIBITED FROM CLAIMING THE MENTO GOVERNANCE TOKEN(S).{" "}
            <br /> <br /> These Airdrop TnCs constitute the entire agreement
            between you and [issuing company] in regard to the Airdrop and
            supersede all prior agreements – if any - between you and the
            [issuing company]. These Airdrop TnCs may be modified from time to
            time in which case the “as of” date of these Airdrop TnCs will be
            updated respectively. The updated Airdrop TnCs will be effective as
            of the time of posting, or at a later date as may be stipulated in
            the updated Airdrop TnCs. By continuing to participate in the
            ...
            The Airdrop is the process of distributing MENTO Governance Tokens
            to existing community members, engaging with the Mento protocol and
            ...
            ecosystem overall. <br />
            <br />
            <strong>Who can claim MENTO Governance Tokens?</strong>
            <br /> Eligible Celo wallet addresses, as further described below,
            can claim a combined maximum of 5% of the overall total supply.
            Users claiming the Airdrop will receive it as veMENTO locked for 2
            years (linearly unlocking without a cliff). After the Airdrop
            period, unclaimed amounts will go to the Mento Community Fund for
            the use of the Mento community. <br />
            <br />
            <strong>What are the Airdrop Eligibility Criteria?</strong> <br />
            To be eligible, a Celo wallet address must fulfill at least one of
            the following criteria:
            <ul className="list-disc">
              <li className="ml-5">
                Staked at least USD 10,00 worth of CELO (amount based on avg.
                over 16 months snapshots, taken between November 15th, 2022, and
                February 15th, 2024);
              </li>
              <li className="ml-5">
                Held more than USD 10,00 worth of any of Mento&apos;s
                decentralized stable assets (amount based on avg. over 16 months
                snapshots, taken between November 15th, 2022, and February 15th,
                2024);
              </li>
              <li className="ml-5">
                Transacted in any of Mento&apos;s decentralized stable assets
                with a volume greater than USD 100,00 (volume calculated as the
                cumulative sum over the 16 months snapshots between November
                15th, 2022, and February 15th, 2024).
              </li>
            </ul>
            Claimable amounts are concave (think square root) in the balances of
            locked CELO and Mento&apos;s decentralized stable assets, as well as
            the Mento stablecoin volumes:
            <ul className="list-disc">
              <li className="ml-5"> 50% allocated to locked CELO holders </li>
              <li className="ml-5">
                50% allocated to holders of Mento&apos;s decentralized stable
                assets
              </li>
            </ul>
            <br />
            Smart contract addresses are excluded, except for ReleaseGold
            addresses (here, we would use the beneficiary address) and Gnosis
            Safes. Mento&apos;s decentralized stable assets held in liquidity
            pools, etc. will not be counted directly because it is not (feasible
            to account for all pools, etc., on all DeFi protocols on Celo), but
            since depositing stablecoins in liquidity pools leads to volume,
            ...
            <br />
            <strong>How to participate in the Airdrop?</strong> <br /> When the
            Airdrop starts, participants can go to airdrop.mento.org, connect a
            compatible third-party digital wallet, check eligibility, provide
            proof of ownership, verify that they are not on a restricted or
            ...
            <br />
            <br /> As further described below, the TnCs refer to “sanction
            lists” which means any sanctions designations listed on
            economic/trade embargo lists and/or specially designated
            ...
            <ol className="list-decimal">
              <li className="ml-5">
                ...
                if the digital wallets are located in, established in, or you
                are a resident of Myanmar (Burma), Cuba, Crimea, Donetsk
                People&apos;s Republic, Democratic Republic of Congo, Iran, the
                so-called Luhansk People&apos;s Republic, Mali, Democratic
                People&apos;s Republic of Korea (North Korea), South Sudan,
                Syria, Yemen.
              </li>
              <br />
              <li className="ml-5">
                <strong>Restricted Persons.</strong> You will NOT be eligible
                with digital wallets, which have been previously classified or
                otherwise identified by international organizations or any state
                and governmental authorities of any jurisdiction, as belonging
                or affiliated with the persons specially designated or otherwise
                included in the Sanction Lists (“Restricted Persons”). For the
                purposes of these TnCs, Restricted Persons shall also include
                all persons or entities who reside in, are citizens of, are
                incorporated in, or have a registered office in the Prohibited
                Localities.
              </li>
              <br />
              <li className="ml-5">
            ...
            investment, undertaking or activity that conceals the identity,
            source or destination of the proceeds from any category of
            ...
            the Financing of Terrorism and Proliferation, as updated from time
            to time, (c) are not identified on the most current list of
            “Specially Designated Nationals and Blocked Persons” published by
            the Office of Foreign Assets Control of the U.S. Department of the
            Treasury (“<strong>OFAC</strong>”) or (d) reside in a country or
            ...
            Airdrop participants. Any such circumvention, or attempted
