    ...
    <div className="modal">
      <div className="modal-content h-[540px] w-[547px] sm:w-full md:min-h-[350px] md:max-w-[547px] flex flex-col p-[18px] bg-white shadow-md rounded-[8px] border-t-[1px] overflow-visible border border-primary-dark">
        ...
        >
          ...
          in the Airdrop, you agree to these Airdrop TnCs. If you don&apos;t
          agree with the Airdrop TnCs, please DO NOT ACCESS, USE, PARTICIPATE in
          the Airdrop. If you DO NOT AGREE to these TnCs YOU SHALL BE PROHIBITED
          FROM CLAIMING THE MENTO GOVERNANCE TOKEN(S). <br /> <br /> These
          Airdrop TnCs constitute the entire agreement between you and [issuing
          company] in regard to the Airdrop and supersede all prior agreements –
          if any - between you and the [issuing company]. These Airdrop TnCs may
          be modified from time to time in which case the “as of” date of these
          Airdrop TnCs will be updated respectively. The updated Airdrop TnCs
          will be effective as of the time of posting, or at a later date as may
          be stipulated in the updated Airdrop TnCs. By continuing to
          participate in the Airdrop after the changes come into effect, you
          agree to the modified Airdrop TnCs. <br />
          <br />
          ...
          <br /> Eligible Celo wallet addresses, as further described below, can
          claim a combined maximum of 5% of the overall total supply. Users
          claiming the Airdrop will receive it as veMENTO locked for 2 years
          (linearly unlocking without a cliff). After the Airdrop period,
          unclaimed amounts will go to the Mento Community Fund for the use of
          the Mento community. <br />
          <br />
          ...
          <ul className="list-disc">
            <li className="ml-5">
              Staked at least USD 10,00 worth of CELO (amount based on avg. over
              16 months snapshots, taken between November 15th, 2022, and
              February 15th, 2024);
            </li>
            <li className="ml-5">
            ...
            <li className="ml-5">
              Transacted in any of Mento&apos;s decentralized stable assets with
              a volume greater than USD 100,00 (volume calculated as the
              cumulative sum over the 16 months snapshots between November 15th,
          ...
          since depositing stablecoins in liquidity pools leads to volume, they
          are counted indirectly. <br />
          <br /> To verify, participants can review raw data from the snapshots
          in CSV files in this GitHub repository. <br />
          <br />
          ...
          <br />
          <br /> As further described below, the TnCs refer to “sanction lists”
          which means any sanctions designations listed on economic/trade
          embargo lists and/or specially designated persons/blocked persons
          lists published by international organisations, as well as any state
          and governmental authorities of any jurisdiction, including, but not
          limited to the lists of United Nations, European Union and its Member
          ...
          <ol className="list-decimal">
            <li className="ml-5">
              ...
              Luhansk People&apos;s Republic, Mali, Democratic People&apos;s
              Republic of Korea (North Korea), South Sudan, Syria, Yemen.
            </li>
            <br />
            <li className="ml-5">
              ...
              purposes of these TnCs, Restricted Persons shall also include all
              persons or entities who reside in, are citizens of, are
          ...
          advisor before participating in the Airdrop. <br />
          <br />
          ...
          use to access or participate in the Airdrop. <br />
          <br />
          ...
          digital assets when participating in the Airdrop. <br />
          <br />
          ...
          investment, undertaking or activity that conceals the identity, source
          or destination of the proceeds from any category of prohibited
          offenses designated by the Financial Action Task Force (“
